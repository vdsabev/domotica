...
module.exports = {
  statics: {
    fields: {
      ...
      read: utils.processFields('_id', 'name', 'description', 'converter', 'system', 'pins', 'connection', 'interval', 'values', 'created'),
      create: utils.processFields('name', 'description', 'converter', 'system', 'pins', 'connection', 'interval'),
      update: utils.processFields('name', 'description', 'converter', 'system', 'pins', 'connection', 'interval')
    },
    query: {
